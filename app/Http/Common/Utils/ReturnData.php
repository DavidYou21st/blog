...
class ReturnData
{
    ...
    const SYSTEM_FAIL           = 500; //系统错误，如数据写入失败之类的
    const PARAMS_ERROR          = 8003; //参数错误
    const NOT_FOUND             = 404; //资源未找到
    ...
    //创建返回
    public static function create($code, $data = null, $msg = '',$count=0)
    {
        ...
        return self::custom($code, $msg, $data,$count);
    }

    public static function success($data = null, $count=0,$msg = '')
    {
        ...
        return self::custom(self::SUCCESS, $msg, $data,$count);
    }

    public static function error($code, $data = null, $msg = '',$count=0)
    {
        if (empty($msg) && isset(self::$codeTexts[$code]))
        {
            $msg = self::$codeTexts[$code];
    ...
    public static function custom($code, $msg = '', $data = null,$count=0)
    {
