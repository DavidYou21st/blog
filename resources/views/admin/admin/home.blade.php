...
<!-- js部分 -->
@section('js')
    <script src="{{asset(__ADMIN_LIBS__.'/echarts/echarts.min.js')}}"></script>
    <script src="{{asset(__ADMIN_LIBS__.'/echarts/china.js')}}"></script>
    <script src="{{asset(__ADMIN_LIBS__.'/echarts/echarts-wordcloud.min.js')}}"></script>
    <script>
